...
<body>
	...
	<div id="find_container">
		<form method="post">
			<div id="find">
				<div id="find_head">
					<h1 id="find_logo"><a href="logout_main.do">Hiscord</a></h1>
					<div id="f_id"">
				...
				<div id="find_info">
					<table>
						<tbody>
							...
							<tr>
								...
								<td><input type="text" class="finding" id="id" name="id"></td>
							</tr>
							<tr>
					...
					<div id="id_finding">
						<input type="submit" value="비밀번호 찾기" onclick="pw_find_go(this.form)">
					</div>
				</div>
			</div>
		</form>
